        ...
        <div className={classes.itemDetails}>
            ...
            <div className={classes.quantity}>
                <div className={classes.quantityBtn} onClick={decrementQty}>
                    <Image src='/assets/icons/minus.svg' alt='minus' width={24} height={24} className={classes.qtnBtn} />
                </div>
                ...
                <div className={classes.quantityBtn} onClick={incrementQty}>
                    <Image src='/assets/icons/plus.svg' alt='plus' width={24} height={24} className={classes.qtnBtn} />
                </div>
            </div>
        </div>
